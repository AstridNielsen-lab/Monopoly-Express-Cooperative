        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="space-y-6">
              ...
              >
                <a
                  href="https://github.com/AstridNielsen-lab/Monopoly-Express-Cooperative/tree/main/CooperativaMotoboy"
                ...
                <p className="text-sm text-gray-400 mt-3">
                  Versão 4.0 • Compatível com Android 7.0+ • <a href="https://github.com/AstridNielsen-lab/Monopoly-Express-Cooperative/tree/main/CooperativaMotoboy" className="text-accent hover:text-accent-light underline">Todas as versões</a>
                </p>
              </motion.div>
            </div>
          </motion.div>
